  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "skydive-left": "skydive-left var(--skydive-duration) linear infinite",
        "skydive-right": "skydive-right var(--skydive-duration) linear infinite",
        "skydive-center": "skydive-center var(--skydive-duration) linear infinite",
