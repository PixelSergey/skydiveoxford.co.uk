  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "skydive-left": "skydive-left var(--duration, var(--skydive-duration)) linear infinite",
        "skydive-right": "skydive-right var(--duration, var(--skydive-duration)) linear infinite",
        "skydive-center": "skydive-center var(--duration, var(--skydive-duration)) linear infinite",
