  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 sm:px-8 max-w-4xl mx-auto w-full">
        <h1 className="text-6xl sm:text-7xl md:text-9xl font-vast font-bold text-primary-foreground mb-4 sm:mb-6 animate-fade-in-up leading-tight tracking-wider">
